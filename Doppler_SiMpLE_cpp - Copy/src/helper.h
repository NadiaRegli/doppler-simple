...
struct params {
    ...
    std::string gtpath;         // gt path
    std::string calibpath;     // calib path
...
/**
 * @brief Calculates the seed for the next pose estimation using a constant velocity model
 * 
 * @param poseEstimates All previous pose estimates
